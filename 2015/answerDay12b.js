...
// Function to recursively find and sum all numbers in a JSON object, ignoring objects with "red"
...
// Example usage
const filePath = 'inputDay12.txt'; // Replace with the path to your JSON file
